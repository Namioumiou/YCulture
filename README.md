...
### `ProfileScreen`
Affiche le niveau, la barre de progression d'XP, et l'historique des 10 derniers quiz (thème, score, date). Un appui sur une entrée de l'historique ouvre `ResultScreen` en mode `isHistoryView`.
