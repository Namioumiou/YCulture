...
- **Résultats** : `addResult` enregistre la session (y compris le snapshot questions / réponses), calcule le gain d'XP, retourne un objet `ExperienceGain` décrivant la progression et persiste.
