...
class _HomeHeaderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final resultsCount = context.select((QuizProvider p) => p.results.length);
    ...
    return Column(
      ...
      children: [
        ...
        _MenuButton(
          ...
          onPressed: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const CreateThemeScreen()),
          ),
        ),
        const SizedBox(height: 14),
        _MenuButton(
        ...
        child: CircleAvatar(
          ...
          child: ClipOval(
            child: avatarPath != null
                ? Image.asset(avatarPath, width: 46, height: 46, fit: BoxFit.cover)
